...
export function WifiScreen() {
  const [networks, setNetworks] = useState<Array<{ ssid: string; bssid: string; rssi: number }>>([]);
  const [accessPoints, setAccessPoints] = useState<Array<{ id: number; ssid: string; bssid: string }>>([]);

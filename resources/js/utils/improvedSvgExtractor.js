async function extractLocationsFromSvg(svgUrl) {
  try {
    console.log(`\u{1F4CD} Extracting from: ${svgUrl}`);
...
async function extractAllFloors() {
  const floorConfigs = [

...
function WifiAPManager({ floorId, accessPoints, onAccessPointsChange }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await fetch(endpoint, {
        ...
        body: JSON.stringify({
          ...formData,
          bssid: formData.bssid?.toLowerCase(),
          floor_id: floorId
        })
      });
      if (!response.ok) {
  ...
  return <div>
    ...
    /* Add/Edit Form */
            ...
            {(isAdding || editingId) && <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
  ...
  >
    ...
    /* Add New Button (shown when not adding/editing) */
            ...
            {!isAdding && !editingId && <div className="mb-6">
                    <button
  ...
  >
    ...
    /* Access Points List */
            ...
            {accessPoints.length === 0 ? <div className="p-4 bg-gray-50 border border-gray-200 rounded text-center text-gray-500">
                    <p>📡 No access points configured for this floor</p>
                    <p className="text-sm mt-1">Click "Add Access Point" to get started</p>
                </div> : <div className="grid grid-cols-1 gap-4">
                    {accessPoints.map((ap) => <div
    key={ap.id}
  ...
  >
    ...
    /* Notes */
                                    ...
                                    {ap.notes && <p className="text-sm text-gray-600 mt-2">

...
export default function Dashboard() {
    ...
    const handleGpsClick = () => {
        // This will trigger the GPS button in the map component via data attribute
        const gpsBtn = document.querySelector('[data-gps-btn]') as HTMLElement;
        if (gpsBtn) {
            gpsBtn.click();
        }
    };
    ...
    return (
        <AppShell variant="sidebar">
            <div className="flex h-screen w-screen bg-gray-50 dark:bg-slate-950">
                ...
                {/* Sidebar - Collapsible */}
                <div
                    className={`fixed left-0 top-0 h-screen bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-800 transition-transform duration-300 z-40 pt-16 w-64 ${
